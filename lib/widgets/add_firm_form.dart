...
class AddFirmForm extends StatefulWidget {
  ...
  @override
  _AddFirmFormState createState() => _AddFirmFormState();
}
...
// The function to show the state selection modal
  ...
  void _initializeFields() {
    ...
    stateCode = widget.initialCompany.firmStateCode; // Updated to firmStateCode
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      final updatedCompany = FirmModel(
        ...
        // Updated
        tcsWithPan: double.tryParse(tcsWithPan) ?? 0.0,
        // Convert back to double
        tcsWithoutPan: double.tryParse(tcsWithoutPan) ?? 0.0,
        // Convert back to double
        tcsAuto: tcsAuto,
        // Remains a String
        tcsAbove: tcsAbove,
  ...
  Widget _buildTextField(
    ...
    // Track the current length of the text
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          // Display current length and max length in suffixText
          suffixText: length != null ? "$currentLength/$length" : null,
          suffixStyle: TextStyle(color: Colors.grey, fontSize: 12),
        ),
        onChanged: onChanged,
        validator: validator,
        maxLength: length,
        // Set maxLength in TextField decoration
        keyboardType: keyboardType,
        inputFormatters: inputFormatters,
        // Use passed inputFormatters
                                        ...
                                        child: isLoading
                                            ...
                                            : TypeAheadField<String>(
                                                ...
                                                onSelected:
                                                  ...
                                                  // Find full data from original list
                                                ...
                                                builder: (context, controller,
                                                    focusNode) {
                                                  // Use your own controller/focusNode if needed
                                                  return TextField(
                                                    controller:
                                                        subGroupController,
