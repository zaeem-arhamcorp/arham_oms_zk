...
ItemListModal itemListModalFromJson(String str) => ItemListModal.fromJson(json.decode(str));
...
class ItemListModal {
  ...
  factory ItemListModal.fromJson(Map<String, dynamic> json) => ItemListModal(
    ...
    data: List<DatumItemList>.from(json["data"].map((x) => DatumItemList.fromJson(x))),
  );
