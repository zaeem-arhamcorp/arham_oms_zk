...
class ItemWiseSaleReportScreen extends StatefulWidget {
  const ItemWiseSaleReportScreen({Key? key}) : super(key: key);
            ...
            totalQty = value.data
                .fold(
                    ...
                    (previousValue, element) =>
                        previousValue + double.parse(element.sumQty.toString()))
                .toPrecision(2);
            totalAmt = value.data
                .fold(
                    0.00,
...
///////////////////////////////////////////////////////////////
  ...
  Widget build(BuildContext context) {
    ...
    try {
      ...
      // Provider not found, try to access it without watching
      print('[ItemWiseSaleReportScreen] Provider error: $e');
      return Scaffold(
