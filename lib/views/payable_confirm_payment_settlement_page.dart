...
class PayableConfirmPaymentSettlementPage extends StatefulWidget {
  @override
  _PayableConfirmPaymentSettlementPageState createState() =>
      _PayableConfirmPaymentSettlementPageState();
}

class _PayableConfirmPaymentSettlementPageState
    extends State<PayableConfirmPaymentSettlementPage> {
                                                                        ...
                                                                        showDialog(
                                                                          ...
                                                                          builder:
                                                                            ...
                                                                            return AlertDialog(
                                                                              ...
                                                                              content:
                                                                                  Text('Are you sure you want to delete payment report? - ${data[index].vOUCHNO.toString()}'),
                                                                              actions: [
                                                                                TextButton(
                                                                                  onPressed: () {
                                                                                ...
                                                                                TextButton(
                                                                                  onPressed: () {
                                                                                    // Confirm logout
                                                                                    deletePayableConfirm(context, data[index].vOUCHNO.toString());
                                                                                  },
                                                                                  child: Text('Yes'),
                                                                                ),
                                                                              ],
  ...
  Future<void> deletePayableConfirm(
      BuildContext context, String vouchNo) async {
    final UserProvider ub = Provider.of<UserProvider>(context, listen: false);

    try {
      String url = '${AppConfig.baseURL}payment-entry/$vouchNo';
      ...
      if (response.statusCode == 200 || response.statusCode == 204) {
        ...
        AppSnackBar.showGetXCustomSnackBar(
            message: "Payment Confirm Entry deleted successfully!",
            backgroundColor: Colors.green);
        // Fluttertoast.showToast(
        //     msg: "Payment Confirm Entry deleted successfully!");
        getConfirmPayableEntry();
      } else {
