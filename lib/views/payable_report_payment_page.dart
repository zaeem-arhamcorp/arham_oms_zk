...
class PayableReportPaymentPage extends StatefulWidget {
  @override
  _PayableReportPaymentPageState createState() =>
      _PayableReportPaymentPageState();
}

class _PayableReportPaymentPageState extends State<PayableReportPaymentPage> {
                                                                          ...
                                                                          showDialog(
                                                                            ...
                                                                            builder:
                                                                              ...
                                                                              return AlertDialog(
                                                                                ...
                                                                                content: Text('Are you sure you want to delete payment report? - ${data[index].vOUCHNO.toString()}'),
                                                                                actions: [
                                                                                  TextButton(
                                                                                    onPressed: () {
