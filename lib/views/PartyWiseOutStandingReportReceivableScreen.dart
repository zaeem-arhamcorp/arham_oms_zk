...
class PartyWiseOutStandingReportReceivableScreen extends StatefulWidget {
  final String? toDate;

  PartyWiseOutStandingReportReceivableScreen({Key? key, this.toDate});

  @override
  State<PartyWiseOutStandingReportReceivableScreen> createState() =>
      _PartyWiseOutStandingReportReceivableScreenState();
}

class _PartyWiseOutStandingReportReceivableScreenState
    extends State<PartyWiseOutStandingReportReceivableScreen> {
  ...
  void initState() {
    ...
    if (moduleEntryAccess.mODULENO == "310") {
      ...
      print("Module with MODULE_NO '310' not found.");
    }
  ...
  showMenu() {
    ...
    pp.getpartynameForReceivable(context);
                ...
                if (printRight)
                  PopupMenuItem(
                    ...
                    onTap: () {
                      ...
                      Services()
                          .getPartyWiseOutStandingExportFileReceivable(
                              context,
                              Helper.toApi(toDateController.text),
                              party.partyid,
                              "pdf")
                      ...
                      children: [
                        ...
                        Flexible(
                          ...
                          child: Text(
                            ...
                            // Large number (replace with your dynamic data)
                            overflow: TextOverflow.visible, // Handle overflow
                            maxLines: null, // Ensure the text doesn't wrap
                          ),
                        ),
                      ],
                    ),
                                                    ...
                                                    Expanded(
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(
                                                            "${Helper.parseNumericValue(data[index].osAmt.toString())}",
                                                            style: TextStyle(
                                                                fontSize: 12,
                                                                color: Colors
                                                                    .grey),
