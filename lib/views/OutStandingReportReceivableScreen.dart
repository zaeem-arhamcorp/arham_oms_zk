...
class OutStandingReportReceivableScreen extends StatefulWidget {
  ...
  State<OutStandingReportReceivableScreen> createState() =>
      _OutStandingReportReceivableScreenState();
}

class _OutStandingReportReceivableScreenState
    extends State<OutStandingReportReceivableScreen> {
  ...
  Future<bool> isWhatsAppInstalledOnIOS() async {
    final uri = Uri.parse("whatsapp://");
    return await canLaunchUrl(uri);
  }

  Future<bool> isWhatsAppBusinessInstalledOnIOS() async {
  ...
  getDate() {
    ...
    Services()
        .getOutStandingReport(context, Helper.toApi(toDateController.text),
            party.partyid, selectedCity != null ? selectedCity!.city : null)
        .then((value) {
      setState(() {
        if (value != null) {
  ...
  void initState() {
    ...
    var moduleEntryAccess = p.data?.modulesList?.firstWhere(
          (module) => module.mODULENO == "307",
          orElse: () => Modules(),
        ) ??
        Modules();

    if (moduleEntryAccess.mODULENO == "307") {
  ...
  FocusNode _cfoucNode = FocusNode();
                ...
                if (printRight)
                  PopupMenuItem(
                    ...
                    onTap: () {
                      ...
                      Services()
                          .getOutStandingExportFileReceivable(
                              context,
                      ...
                      Services()
                        ...
                        if (value != null) {
                          Helper.saveFileAndroid(
                            ...
                            if (value != null) if (Platform.isIOS) {
                                                ...
                                                Expanded(
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        "${Helper.parseNumericValue(data[index].sumPaidAmt.toString())}",
                                                        style: TextStyle(
                                                            fontSize: 12,
                                                            color: Colors.grey),
                                                      )
                                                ...
                                                Expanded(
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        "${Helper.parseNumericValue(data[index].sumOsAmt.toString())}",
                                                        style: TextStyle(
                                                            fontSize: 12,
                                                            color: Colors.grey),
                                                      )
  ...
  Future<void> shareFileToWhatsAppIOS(String filePath) async {
